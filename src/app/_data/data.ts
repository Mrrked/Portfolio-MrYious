...
export const MyData = {
    ...
    projects: [
        ...
        },
        {
            title: "TODO App",
            image: ToDo,
            description: "A simple website for personal task management. It has a light/dark toggle for theme selection and has a mobile-friendly interface. A challenged accepted from FrontendMentor.io",
